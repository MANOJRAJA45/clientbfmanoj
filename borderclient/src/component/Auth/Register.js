    ...
    return (
        <Fragment>
            ...
            <div class="form-row">
                ...
                <input type="text"  name='phone' value={phone} maxLength="10" onChange={onChange} class="form-control" id="inputphone4" placeholder="Mobile Number" />
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <input type="text" class="form-control" id="inputZip"  name='pincode' maxLength="6" value={pincode} onChange={onChange}  placeholder="ZipCode "/>
                </div>
            </div>
            <div className='checkbox'>
                <input type="checkbox" name="checkbox" id="checkbox" required/>
                <label htmlFor="checkbox"> I agree to Terms & Conditions from Fashion styling  </label>
            </div>
