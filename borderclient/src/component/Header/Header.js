...
const Navbar = ({ auth: { isAuthenticated }, logout }) => {
    ...
    const authLinks = (
        <Fragment>
        <Link to='/dashboard'><button  className="btn btn-outline-success my-2 my-sm-0" type="submit">All Fashion</button></Link>&nbsp; &nbsp;
    ...
    return (
        <Fragment>
            ...
            <Link className="navbar-brand" to='/'>Fashion Styling</Link>
